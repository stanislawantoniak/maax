        ...
        <nav><!-- ALTERNATYWNA PRZERWA MIĘDZY POZYCJAMI LISTY <li class="separator"></li> -->
            ...
            <ul class="sb-menu">
                ...
                <li>
                 ...
                 <li>
                    <a href="{{store direct_url='lookbook' _no_vendor='1'}}">
                        <img src="{{skin url='images/svg/crown.svg' _no_protocol='1'}}" class="hamburger-ico ico-crown">Lookbook
                    </a>
                </li>
                <li>
            ...
            <ul class="sb-menu">
                ...
                <li>
                    <a href="{{store direct_url='help/contact' _no_vendor='1'}}">
                        <img src="{{skin url='images/svg/contact.svg' _no_protocol='1'}}" class="hamburger-ico ico-label">KONTAKT
                    </a>
                </li>
                <li>
                    <a href="{{store direct_url='regulamin' _no_vendor='1'}}">
                ...
                <li>
                    <a href="{{store direct_url='o-nas' _no_vendor='1'}}">
