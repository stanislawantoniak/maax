...
class Zolago_Banner_Block_Adminhtml_SystemConfigField_TypesConfig extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('zolagobanner/system/form_field/types_config.phtml');
        }
    }
