...
<div style="border-top:15px solid white;border-bottom:35px solid white;line-height:1.4em;margin:0;padding:0">
                                                                        <b>Nie odpowiadaj na ten e-mail</b>, gdyż został on wysłany przez automat. <br/><a target="_blank" style="text-decoration:none;color:#15c" href="{{var question_url}}">Aby odpowiedzieć Klientowi, kliknij tutaj i zaloguj się do panelu obsługi sklepu.</a> 
