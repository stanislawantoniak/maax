 ...
 */
require_once Mage::getModuleDir('controllers', "SolrBridge_Solrsearch") . DS . "AjaxController.php";
class Zolago_Solrsearch_AjaxController extends Mage_Core_Controller_Front_Action
{
	...
	public function queryAction()
	{
        ...
        $solrChangeContext = Mage::getSingleton('core/session')->getData('solr_change_context');
		...
		if (false !== ($returnData = Mage::app()->getCache()->load($cachedKey)) && intval($autocomplete_cache_enable) > 0 && $solrChangeContext == 0)
		{
