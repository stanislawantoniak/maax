...
<p class="form-instructions ff_os fz_11">Jeśli konto <span class="latoblack">{{var customer_email}}</span> istnieje w naszym serwisie, otrzymasz zaraz od nas maila.</p>
