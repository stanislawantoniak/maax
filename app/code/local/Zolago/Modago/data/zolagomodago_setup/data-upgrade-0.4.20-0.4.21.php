...
<div class="col-md-6 col-sm-8 hidden-xs text-right">
  <ul class="vendor-top-bottom-header-links">
    ...
    <li><a data-target="#brand_description" data-toggle="modal">o marce</a></li>
  </ul>
</div>
...
EOD
    ...
    array(
        'title'         => 'Top bottom header desktop vendor Matterhorn new',
        'identifier'    => 'top-bottom-header-desktop-v-5',
        'content'       => <<<EOD
<div class="container-fluid vendor-top-bottom-header action-box-bundle clearfix">
<div class="col-md-6 col-sm-4 logo-part">
{{block name="vendor.logo"  vendor_label="Sklep" type="zolagoudmspro/vendor_logo" template="unirgy/microsite/vendor.logo.phtml"}}
