...
<section id="rma-page" class="cms-section">
	<div class="rma-page-header">
		...
		<div class="rma-page-header2">Produkty zwracasz&nbsp;w <strong>100%&nbsp;ZA&nbsp;DARMO!</strong></div>
	</div>
	<div class="benefits">
		<div class="benefit-item">
			<div class="benefit-text" style="background-image: url('/skin/frontend/modago/gallery/images/svg/notebook.svg')">
				<strong>Zgłaszasz zwrot lub reklamację w zaledwie kilku klikach.</strong>
			</div>
		</div>
		<div class="benefit-item">
			<div class="benefit-text" style="background-image: url('/skin/frontend/modago/gallery/images/svg/help_orders.svg')">
				<strong>Na bieżąco masz wgląd w status swojego zgłoszenia.</strong>
			</div>
		</div>
		<div class="benefit-item">
			<div class="benefit-text" style="background-image: url('/skin/frontend/modago/gallery/images/svg/about_delivery_quick.svg')">
				<strong>Szybko zamawiasz kuriera przez stronę Modago.pl.</strong>
			</div>
		</div>
		<div class="benefit-item">
			<div class="benefit-text" style="background-image: url('/skin/frontend/modago/gallery/images/svg/wallet.svg')">
				<strong>Błyskawicznie otrzymujesz zwrot płatności.</strong>
			</div>
		</div>
	</div>
