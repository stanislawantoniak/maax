...
<h1 style="font-weight:normal;font-size:21px;border-bottom:25px solid white;font-family:'Arial','Helvetica',sans-serif;line-height:1.4em">Propozycja nowej wartości atrybutu
</h1>
<h2 style="font-size: 15px;border-bottom:10px solid white;font-family:'Arial','Helvetica',sans-serif;margin:0;padding:0;line-height:1.4em">Sprzedawca:
</h2>
<div style="border-bottom:25px solid white;line-height: 1.4em;margin:0;padding:0;line-height:1.4em">
     {{var vendorName}}
</div>
<h2 style="font-size: 15px;border-bottom:10px solid white;font-family:'Arial','Helvetica',sans-serif;margin:0;padding:0;line-height:1.4em">Zgłaszający:
</h2>
<div style="border-bottom:25px solid white;line-height: 1.4em;margin:0;padding:0;line-height:1.4em">
     {{var userName}} (<a href="mailto:{{var userEmail}}">{{var userEmail}}</a>)
</div>
<h2 style="font-size: 15px;border-bottom:10px solid white;font-family:'Arial','Helvetica',sans-serif;margin:0;padding:0;line-height:1.4em">Atrybut:
</h2>
<div style="border-bottom:25px solid white;line-height: 1.4em;margin:0;padding:0;line-height:1.4em">
     {{var attributeName}} [{{var attributeCode}}] z zestawu &quot;{{var attributeSetName}}&quot;
</div><h2 style="font-size: 15px;border-bottom:10px solid white;border-top:10px solid white;font-family:'Arial','Helvetica',sans-serif;margin:0;padding:0;line-height:1.4em">
	Wartość atrybutu:
</h2>
<div style="border-bottom:25px solid white;line-height: 1.4em;margin:0;padding:0;line-height:1.4em">
{{var attributeValue}}
...
$subject  = "Sugestia nowej wartości atrybutu";
$code     = "New value attribute suggestion";
