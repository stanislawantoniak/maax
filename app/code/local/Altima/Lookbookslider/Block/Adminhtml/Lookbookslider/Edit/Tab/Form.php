...
class Altima_Lookbookslider_Block_Adminhtml_Lookbookslider_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
  protected function _prepareForm()
  {
     ...
     $fieldset->addField('no_resample', 'select', array(
          'label'     => Mage::helper('lookbookslider')->__('Deny resize images. '),
          'name'      => 'no_resample',
          'values'    => array(
              array(
                  'value'     => 1,
          ...
          'note'    => Mage::helper('lookbookslider')->__('No re-sample for images that exactly match slide size'),
      )); 
