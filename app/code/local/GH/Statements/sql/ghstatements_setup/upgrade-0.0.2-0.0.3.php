...
$table = $installer->getConnection()
    ...
    ->addColumn('shipped_date', Varien_Db_Ddl_Table::TYPE_TIMESTAMP, null, array(
        'nullable'  => false,
    ), 'Shipped date')
    ...
    ->addColumn('track_number', Varien_Db_Ddl_Table::TYPE_TEXT, '64K', array(
     ...
     ->addColumn("charge_shipment", Varien_Db_Ddl_Table::TYPE_FLOAT, null, array(
         'nullable' => true,
     ), 'Shipment charge')

    ->addColumn("charge_fuel", Varien_Db_Ddl_Table::TYPE_FLOAT, null, array(
         'nullable' => true,
     ), 'Fuel charge')

     ->addColumn("charge_insurance", Varien_Db_Ddl_Table::TYPE_FLOAT, null, array(
         'nullable' => true,
     ), 'Insurance charge')

     ->addColumn("charge_cod", Varien_Db_Ddl_Table::TYPE_FLOAT, null, array(
         'nullable' => true,
     ), 'COD charge')

    ->addColumn("charge_subtotal", Varien_Db_Ddl_Table::TYPE_FLOAT, null, array(
        'nullable' => true,
    ), 'Total netto shipment charge')

    ->addColumn("charge_total", Varien_Db_Ddl_Table::TYPE_FLOAT, null, array(
        'nullable' => true,
