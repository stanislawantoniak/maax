...
class Unirgy_DropshipTierShipping_Helper_Data extends Mage_Core_Helper_Abstract
{
    ...
    {
        return $this->_getV2RateObj(Unirgy_DropshipTierShipping_Model_Source::USE_RATES_V2, $isVendor);
    }
    public function getV2SimpleRateObj($isVendor=false)
    {
        return $this->_getV2RateObj(Unirgy_DropshipTierShipping_Model_Source::USE_RATES_V2_SIMPLE, $isVendor);
    }
    public function getV2SimpleCondRateObj($isVendor=false)
    {
        return $this->_getV2RateObj(Unirgy_DropshipTierShipping_Model_Source::USE_RATES_V2_SIMPLE_COND, $isVendor);
    }
