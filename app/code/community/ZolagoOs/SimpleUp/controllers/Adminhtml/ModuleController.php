...
class ZolagoOs_SimpleUp_Adminhtml_ModuleController extends Mage_Adminhtml_Controller_Action
{
...
exit;
    ...
    public function postAction()
    {
        ...
        if (($m = Mage::getConfig()->getNode('modules/ZolagoOs_SimpleLicense')) && $m->is('active')) {
            switch ($action) {
    ...
    {
        try {
            /* @var $installer ZolagoOs_SimpleUp_Model_Resource_Setup */
            $installer = new ZolagoOs_SimpleUp_Model_Resource_Setup('usimpleup_setup');
            $installer->reinstall();
