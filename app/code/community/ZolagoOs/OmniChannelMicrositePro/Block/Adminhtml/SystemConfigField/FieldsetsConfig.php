...
class ZolagoOs_OmniChannelMicrositePro_Block_Adminhtml_SystemConfigField_FieldsetsConfig extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    {
        return Mage::app()->getLayout()->getBlockSingleton('udmspro/adminhtml_systemConfigField_fieldsetsColumnConfig')
            ->setTemplate('udmspro/system/form_field/fieldset_column_config.phtml')
