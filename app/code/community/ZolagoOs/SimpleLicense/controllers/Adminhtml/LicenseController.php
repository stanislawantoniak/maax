...
class ZolagoOs_SimpleLicense_Adminhtml_LicenseController extends Mage_Adminhtml_Controller_Action
{
    public function addLicenseAction()
    {
        try {
            ...
            ZolagoOs_SimpleLicense_Helper_Protected::retrieveLicense($key, $install);
    ...
    public function checkUpdatesAction()
    {
        try {
            ...
            foreach ($licenses as $license) {
                ZolagoOs_SimpleLicense_Helper_Protected::retrieveLicense($license);
                try {
                    ZolagoOs_SimpleLicense_Helper_Protected::validateLicense($license);
                } catch (Exception $e) {
                    Mage::getSingleton('adminhtml/session')->addError($e->getMessage());
                }
            }
    ...
    {
        try {
            ZolagoOs_SimpleLicense_Helper_Protected::sendServerInfo();
    ...
    {
        try {
            /* @var $installer ZolagoOs_SimpleLicense_Model_Resource_Setup */
            $installer = new ZolagoOs_SimpleLicense_Model_Resource_Setup('usimplelic_setup');
            $installer->reinstall();
