...
class ZolagoOs_OmniChannelPayout_Model_Mysql4_Payout extends ZolagoOs_OmniChannel_Model_Mysql4_Vendor_Statement_Abstract
{
    ...
    protected function _afterSave(Mage_Core_Model_Abstract $object)
    {
        ...
        if ($object->getPayoutStatus() == ZolagoOs_OmniChannelPayout_Model_Payout::STATUS_CANCELED) {
            $this->_cleanPayout($object);
            return $this;
        }
