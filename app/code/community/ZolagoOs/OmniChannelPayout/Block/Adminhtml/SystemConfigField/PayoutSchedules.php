...
class ZolagoOs_OmniChannelPayout_Block_Adminhtml_SystemConfigField_PayoutSchedules extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    ...
    public function __construct()
    {
        parent::__construct();
        if (!$this->getTemplate()) {
            $this->setTemplate('udpayout/system/form_field/payout_schedules.phtml');
        }
    }
