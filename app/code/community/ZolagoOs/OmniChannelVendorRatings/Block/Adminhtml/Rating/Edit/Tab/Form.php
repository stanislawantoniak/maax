...
class ZolagoOs_OmniChannelVendorRatings_Block_Adminhtml_Rating_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form
{
    protected function _prepareForm()
    {
        ...
        $fieldset->addField('is_aggregate', 'select', array(
            'name'      => 'is_aggregate',
            'label'     => $this->__('Is Aggregatable'),
            'disabled'  => Mage::registry('rating_data'),
