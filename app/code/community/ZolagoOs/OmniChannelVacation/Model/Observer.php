...
class ZolagoOs_OmniChannelVacation_Model_Observer
{
    ...
    public function udropship_prepare_quote_items_after($observer)
    {
        foreach ($observer->getItems() as $item) {
            ...
            if (ZolagoOs_OmniChannelVacation_Model_Source::MODE_VACATION_NOTIFY == $iVendor->getData('vacation_mode')) {
    ...
    public function processVacations()
    {
        ...
        $vacDisabled = ZolagoOs_OmniChannelVacation_Model_Source::MODE_VACATION_DISABLE;
        $vacNo = ZolagoOs_OmniChannelVacation_Model_Source::MODE_NOT_VACATION;
