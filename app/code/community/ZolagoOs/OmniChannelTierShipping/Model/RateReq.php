...
class ZolagoOs_OmniChannelTierShipping_Model_RateReq extends Varien_Object
{
    public function getResult()
    {
        $tsHlp = Mage::helper('udtiership');
        $rateRes = new ZolagoOs_OmniChannelTierShipping_Model_RateRes(array(
        ...
        $flVendorBase = $fallbackLookup == ZolagoOs_OmniChannelTierShipping_Model_Source::FL_VENDOR_BASE;
        $flVendorDefault = $fallbackLookup == ZolagoOs_OmniChannelTierShipping_Model_Source::FL_VENDOR_DEFAULT;
        $flTier = $fallbackLookup == ZolagoOs_OmniChannelTierShipping_Model_Source::FL_TIER;
        $keyChain = array(
        ...
        if ($fallbackLookup == ZolagoOs_OmniChannelTierShipping_Model_Source::FL_VENDOR_BASE) {
            $keyOrder = array('vendor_exact','vendor_base','global_exact','global_base','vendor_default','global_default');
        } elseif ($fallbackLookup == ZolagoOs_OmniChannelTierShipping_Model_Source::FL_TIER) {
