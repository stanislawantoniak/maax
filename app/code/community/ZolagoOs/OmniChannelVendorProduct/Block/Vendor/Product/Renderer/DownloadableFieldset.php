...
class ZolagoOs_OmniChannelVendorProduct_Block_Vendor_Product_Renderer_DownloadableFieldset extends Mage_Core_Block_Template implements Varien_Data_Form_Element_Renderer_Interface
{
    protected $_element;
