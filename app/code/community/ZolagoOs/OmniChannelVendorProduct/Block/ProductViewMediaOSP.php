...
class ZolagoOs_OmniChannelVendorProduct_Block_ProductViewMediaOSP extends OrganicInternet_SimpleConfigurableProducts_Catalog_Block_Product_View_Media
{
    ...
    protected function _processImage($gImage=null)
    {
        ...
        if ($gImage->getZolagoOsImgFlag()) return $gImage;
        ...
        if ($_product->getIsProductListFlag() || $gImage->getOnlyMainUrlFlag()) {
            ...
            if ('thumb' == $gImage->getOnlyMainUrlFlag()) {
                ...
                $gImage->setZolagoOsImgFlag(true);
            } else {
                $gImage->setMedium(
                    $this->helper('catalog/image')->init($_product, $imageAttr, $gImage->getFile())
