...
class ZolagoOs_IAIShop_Model_Client
{
    ...
    public function addOrders($params)
    {
        ...
        $request['addOrders']['params']['orders'][0]['delivery_address']['firstname'] = "firstname";
        ...
        $request['addOrders']['params']['orders'][0]['order_operator'] = "order_operator";
