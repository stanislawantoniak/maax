...
class ZolagoOs_OmniChannel_Model_Vendor extends Mage_Core_Model_Abstract
{
    ...
    */
    ...
    protected function _getAddressObj($useBilling=false)
    {
        ...
        $address->setFirstname($address->getVendorName());
    ...
    public function getHandlingFee()
    {
        ...
        if (is_array($handlingConfig) && !empty($handlingConfig)
            ...
            && $this->getData('use_handling_fee') == ZolagoOs_OmniChannel_Model_Source::HANDLING_ADVANCED
        ) {
            $ruleValue = null;
    ...
    {
        if (!Mage::helper('udropship')->isModuleActive('ZolagoOs_OmniChannelMicrositePro')) return false;
