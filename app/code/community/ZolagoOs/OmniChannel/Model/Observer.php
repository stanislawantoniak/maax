...
class ZolagoOs_OmniChannel_Model_Observer extends Varien_Object
{
    ...
    */
    ...
    {
        try {
            ZolagoOs_OmniChannel_Helper_Protected::validateLicense($observer->getModule());
        } catch (Exception $e) {
    ...
    protected function _initConfigRewrites()
    {
        ...
        if (Mage::getStoreConfig('udropship/stock/availability')=='local_if_in_stock') {
            if (Mage::helper('udropship')->isEE()
                ...
                Mage::getConfig()->setNode('global/models/cataloginventory_resource/rewrite/indexer_stock_configurable', 'ZolagoOs_OmniChannel_Model_StockIndexer_EE11300_Configurable');
                Mage::getConfig()->setNode('global/models/cataloginventory_resource/rewrite/indexer_stock_grouped', 'ZolagoOs_OmniChannel_Model_StockIndexer_EE11300_Grouped');
                */
