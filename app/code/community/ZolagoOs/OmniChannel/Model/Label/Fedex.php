...
class ZolagoOs_OmniChannel_Model_Label_Fedex
    extends Mage_Usa_Model_Shipping_Carrier_Fedex
    implements ZolagoOs_OmniChannel_Model_Label_Interface_Carrier
{
...
#echo "<textarea style='width:100%; height:200px'>".$labelImage."</textarea>"; exit;
    ...
    public function collectTracking($v, $trackIds)
    {
        ...
        foreach ($trackIds as $trackId) {
            ...
            $result[$trackId] = ZolagoOs_OmniChannel_Model_Source::TRACK_STATUS_PENDING;
            ...
            */
            ...
            if (in_array($status, array('CA'/*cancelled*/))) {
                //cancel
                $result[$trackId] = ZolagoOs_OmniChannel_Model_Source::TRACK_STATUS_CANCELED;
                continue;
            }
            if (in_array($status, array('DL'/*delivered*/))) {
                //delivered
                $result[$trackId] = ZolagoOs_OmniChannel_Model_Source::TRACK_STATUS_DELIVERED;
                continue;
            }
            $result[$trackId] = ZolagoOs_OmniChannel_Model_Source::TRACK_STATUS_READY;
        }
    ...
    public function getSoapClient($v, $service)
    {
        ...
        $wsdlFile = Mage::getConfig()->getModuleDir('etc', 'ZolagoOs_OmniChannel').DS.'fedex'
