...
class ZolagoOs_OmniChannel_Model_Source extends ZolagoOs_OmniChannel_Model_Source_Abstract
{
    ...
    public function toOptionHash($selector=false)
    {
        ...
        case 'shipping_tax_in_shipping':
            ...
            if (in_array($this->getPath(), array('apply_commission_on_tax','apply_commission_on_discount','shipping_tax_in_shipping'))) {
                $options = array('999' => $hlp->__('* Default (global setting)')) + $options;
            }
            break;
