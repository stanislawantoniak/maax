...
abstract class ZolagoOs_OmniChannel_Model_Vendor_Statement_Abstract extends Mage_Core_Model_Abstract implements ZolagoOs_OmniChannel_Model_Vendor_Statement_Interface
{
    ...
    public function initOrder($po)
    {
        ...
        $order = array(
            ...
            'po_type' => $po instanceof ZolagoOs_OmniChannelPo_Model_Po ? 'po' : 'shipment'
        );
    ...
    static public function processPos($pos, $subtotalBase)
    {
        ...
        if ($poItemsToLoad) {
            ...
            $poType = $samplePo instanceof ZolagoOs_OmniChannelPo_Model_Po ? 'po' : 'shipment';
