...
class ZolagoOs_OmniChannel_Model_Vendor_Statement extends ZolagoOs_OmniChannel_Model_Vendor_Statement_Abstract
{
    ...
    public function createPayout()
    {
        ...
        $payout = Mage::helper('udpayout')->createPayout(
                $this->getVendor(), 
                ZolagoOs_OmniChannelPayout_Model_Payout::STATUS_PROCESSING, 
                ZolagoOs_OmniChannelPayout_Model_Payout::TYPE_STATEMENT
            )
