...
class ZolagoOs_OmniChannel_Model_Stock_Item extends Mage_CatalogInventory_Model_Stock_Item
{
    /**
    ...
    */
    ...
    {
        $isMP = Mage::helper('udropship')->isModuleActive('ZolagoOs_OmniChannelVendorProduct');
        if (!$isMP) {
