...
class ZolagoOs_OmniChannel_Model_Indexer_VendorProductAssoc extends Mage_Index_Model_Indexer_Abstract
{
    ...
    protected $_matchedEntities = array(
        ...
        ZolagoOs_OmniChannel_Model_Vendor::ENTITY => array(
            Mage_Index_Model_Event::TYPE_SAVE,
    ...
    {
        return Mage::helper('udropship')->__('ZolagoOs Vendor-Product Associations Indexer');
    }
    ...
    protected function _registerEvent(Mage_Index_Model_Event $event)
    {
        ...
        } else if ($entity == ZolagoOs_OmniChannel_Model_Vendor::ENTITY) {
            switch ($event->getType()) {
                case Mage_Index_Model_Event::TYPE_SAVE:
