...
class ZolagoOs_OmniChannel_Model_Mysql4_Vendor_Statement extends ZolagoOs_OmniChannel_Model_Mysql4_Vendor_Statement_Abstract
{
    ...
    protected function _beforeDelete(Mage_Core_Model_Abstract $object)
    {
        if (Mage::helper('udropship')->isUdpayoutActive()) {
            $ptCollection = Mage::getResourceModel('udpayout/payout_collection')
                ...
                ->addFieldToFilter('payout_status', ZolagoOs_OmniChannelPayout_Model_Payout::STATUS_HOLD);
    ...
    {
        return $this->_changePosAttribute(array_keys($statement->getUnpaidOrders()), $statement->getPoType(), 'udropship_payout_status', ZolagoOs_OmniChannelPayout_Model_Payout::STATUS_HOLD);
    }
    
    public function markPosPaid($statement)
    {
        return $this->_changePosAttribute(array_keys($statement->getUnpaidOrders()), $statement->getPoType(), 'udropship_payout_status', ZolagoOs_OmniChannelPayout_Model_Payout::STATUS_PAID);
    }
