...
class ZolagoOs_OmniChannel_Model_Mysql4_Vendor extends Mage_Core_Model_Mysql4_Abstract
{
            ...
            switch (Mage::getStoreConfig('zolagoos/customer/vendor_enable_disable_action')) {
                case 'enable_disable':
                    switch ($vendor->getStatus()) {
                        ...
                        case ZolagoOs_OmniChannel_Model_Source::VENDOR_STATUS_DISABLED:
                            $prodStatus = Mage_Catalog_Model_Product_Status::STATUS_DISABLED;
                            break;
                        case ZolagoOs_OmniChannel_Model_Source::VENDOR_STATUS_ACTIVE:
