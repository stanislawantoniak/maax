...
(function() {
	...
	}, jQuery.validator.format(Translator.translate("Please enter {0} words or less.")));

	jQuery.validator.addMethod("minWords", function(value, element, params) {
		return this.optional(element) || stripHtml(value).match(/\b\w+\b/g).length >= params;
	}, jQuery.validator.format(Translator.translate("Please enter at least {0} words.")));
...
}, Translator.translate("Letters or punctuation only please"));

jQuery.validator.addMethod("alphanumeric", function(value, element) {
	return this.optional(element) || /^\w+$/i.test(value);
}, Translator.translate("Letters, numbers, and underscores only please"));

jQuery.validator.addMethod("lettersonly", function(value, element) {
	return this.optional(element) || /^[a-z]+$/i.test(value);
}, Translator.translate("Letters only please"));

jQuery.validator.addMethod("nowhitespace", function(value, element) {
	return this.optional(element) || /^\S+$/i.test(value);
}, Translator.translate("No white space please"));

jQuery.validator.addMethod("ziprange", function(value, element) {
	return this.optional(element) || /^90[2-5]\d\{2\}-\d{4}$/.test(value);
}, Translator.translate("Your ZIP-code must be in the range 902xx-xxxx to 905-xx-xxxx"));

jQuery.validator.addMethod("zipcodeUS", function(value, element) {
	return this.optional(element) || /\d{5}-\d{4}$|^\d{5}$/.test(value);
}, Translator.translate("The specified US ZIP Code is invalid"));

jQuery.validator.addMethod("integer", function(value, element) {
	return this.optional(element) || /^-?\d+$/.test(value);
}, Translator.translate("A positive or negative non-decimal number please"));
...
}, Translator.translate('Must be before corresponding end date'));
...
}, Translator.translate('Must be after corresponding start date'));
...
}, Translator.translate("Telephone number is too short. Number must contain 9 digits, without spacing."));
...
}, Translator.translate("Tax number is incorrect. Enter as a string of digits e.g. 1234567890."));
...
jQuery.validator.addMethod("imageRequired", function (value, element) {
    ...
    return result;
}, Translator.translate("Image is required"));
/**
...
jQuery.validator.addMethod("vinUS", function(v) {
	...
	return false;
}, Translator.translate("The specified vehicle identification number (VIN) is invalid."));
...
}, Translator.translate("Please enter a correct date"));
...
jQuery.validator.addMethod("iban", function(value, element) {
	...
	return cRest === 1;
}, Translator.translate("Please specify a valid IBAN"));
...
}, Translator.translate("Please specify a valid phone number."));

jQuery.validator.addMethod("mobileNL", function(value, element) {
	return this.optional(element) || /^((\+|00(\s|\s?\-\s?)?)31(\s|\s?\-\s?)?(\(0\)[\-\s]?)?|0)6((\s|\s?\-\s?)?[0-9]){8}$/.test(value);
}, Translator.translate("Please specify a valid mobile number"));

jQuery.validator.addMethod("postalcodeNL", function(value, element) {
	return this.optional(element) || /^[1-9][0-9]{3}\s?[a-zA-Z]{2}$/.test(value);
}, Translator.translate("Please specify a valid postal code"));
...
jQuery.validator.addMethod("bankaccountNL", function(value, element) {
	...
	return sum % 11 === 0;
}, Translator.translate("Please specify a valid bank account number"));
...
}, Translator.translate("Please specify a valid giro account number"));

jQuery.validator.addMethod("bankorgiroaccountNL", function(value, element) {
	return this.optional(element) ||
			($.validator.methods["bankaccountNL"].call(this, value, element)) ||
			($.validator.methods["giroaccountNL"].call(this, value, element));
}, Translator.translate("Please specify a valid bank or giro account number"));


jQuery.validator.addMethod("time", function(value, element) {
	return this.optional(element) || /^([01]\d|2[0-3])(:[0-5]\d){1,2}$/.test(value);
}, Translator.translate("Please enter a valid time, between 00:00 and 23:59"));
jQuery.validator.addMethod("time12h", function(value, element) {
	return this.optional(element) || /^((0?[1-9]|1[012])(:[0-5]\d){1,2}(\ ?[AP]M))$/i.test(value);
}, Translator.translate("Please enter a valid time in 12-hour am/pm format"));
...
}, Translator.translate('Please specify a valid uk phone number'));
...
}, Translator.translate('Please specify a valid UK postcode'));

// TODO check if value starts with <, otherwise don't try stripping anything
jQuery.validator.addMethod("strippedminlength", function(value, element, param) {
	return jQuery(value).text().length >= param;
}, jQuery.validator.format(Translator.translate("Please enter at least {0} characters")));

// same as email, but TLD is optional
jQuery.validator.addMethod("email2", function(value, element, param) {
	return this.optional(element) || /^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)*(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i.test(value);
}, Translator.translate(jQuery.validator.messages.email));

// same as url, but TLD is optional
jQuery.validator.addMethod("url2", function(value, element, param) {
	return this.optional(element) || /^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)*(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i.test(value);
}, Translator.translate(jQuery.validator.messages.url));
...
jQuery.validator.addMethod("creditcardtypes", function(value, element, param) {
	...
	return false;
}, Translator.translate("Please enter a valid credit card number."));

jQuery.validator.addMethod("ipv4", function(value, element, param) {
	return this.optional(element) || /^(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)\.(25[0-5]|2[0-4]\d|[01]?\d\d?)$/i.test(value);
}, Translator.translate("Please enter a valid IP v4 address."));
...
}, Translator.translate("Please enter a valid IP v6 address."));
...
}, Translator.translate("Invalid format."));
...
jQuery.validator.addMethod("require_from_group", function(value, element, options) {
	...
	return validOrNot;
}, jQuery.format(Translator.translate("Please fill at least {0} of these fields.")));
...
jQuery.validator.addMethod("skip_or_fill_minimum", function(value, element, options) {
	...
	return valid;
}, jQuery.format(Translator.translate("Please either skip these fields or fill at least {0} of them.")));
...
jQuery.validator.addMethod("accept", function(value, element, param) {
	...
	return true;
}, jQuery.format(Translator.translate("Please enter a value with a valid mimetype.")));

// Older "accept" file extension method. Old docs: http://docs.jquery.com/Plugins/Validation/Methods/accept
jQuery.validator.addMethod("extension", function(value, element, param) {
	param = typeof param === "string" ? param.replace(/,/g, '|') : "png|jpe?g|gif";
	return this.optional(element) || value.match(new RegExp(".(" + param + ")$", "i"));
}, jQuery.format(Translator.translate("Please enter a value with a valid extension.")));
...
jQuery.validator.addMethod("lessthat", function(value, element, param) {
	...
	return this.optional(element);
}, jQuery.format(Translator.translate("Value is greather that expected")));
...
jQuery.validator.addMethod('integer', function(value, element) {
	return this.optional(element) || /^-?(?:\d+)$/.test(value);
}, jQuery.format(Translator.translate("Enter valid integer")));

// positiveInteger
jQuery.validator.addMethod('positiveInteger', function(value, element) {
	return this.optional(element) || /^\d+$/.test(value);
}, jQuery.format(Translator.translate("Enter valid positive integer")));

// number
jQuery.validator.addMethod('number', function(value, element) {
	return this.optional(element) || /^-?(?:\d+((?:,|\.)\d+)?)$/.test(value);
}, jQuery.format(Translator.translate("Enter valid number")));
...
}, jQuery.format(Translator.translate("Url key already exists")));
...
}, jQuery.format(Translator.translate("The converter price of product or one of child product is not available")));

/*
 * Validate price
 * for example valid result when:
 * 999.999 false
 * 999.99  true
 * 999.9   true
 * 999.    false
