    ...
    if (data.poses.length > 0) {
        ...
        for (var i = 0; i < data.poses.length; i++) {
            ...
            list += "<li>" +
                ...
                "<div class='buttons'>" +
                "<a class='button button-third large' href='' data-markernumber='" + posId + "' onclick='showMarkerWindow(this);return false;'><i class='fa fa-map-marker'></i> "+showOnMapLink+"</a>" +
                "<a class='button button-third large' href='"+generateDirectionLink(pos)+"' target='_blank'><i class='fa fa-compass'></i> "+defineTheRoute+"</a>" +
                "<a class='button button-third large' href='' ' onclick='return false;'><i class='fa fa-phone'></i> "+selectNumber+"</a>" +
                "</div>" +
                "</div>" +
