...
class SkuFinderItemProcessor extends Magmi_ItemProcessor
{
    ...
    public function processItemBeforeId(&$item,$params=null)
	{
		...
		//replaced by SA - poprawka z netu

		$sql="SELECT sku FROM ".$this->tablename("catalog_product_entity")." as cpe
		JOIN catalog_product_entity_".$attinfo["backend_type"].
		" ON catalog_product_entity_".$attinfo["backend_type"].".entity_id = cpe.entity_id AND value=? AND attribute_id=?";
